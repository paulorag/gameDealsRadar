...
const variantStyles: Record<ButtonVariant, string> = {
    ...
    danger:
        "bg-red-500 text-white hover:bg-red-600 border border-red-500/70 shadow-lg shadow-red-500/20 hover:shadow-red-500/30",
    ghost:
        "bg-transparent text-emerald-300 hover:bg-emerald-400/15 border border-emerald-400/50 shadow-none",
};
